...
public class GridAdapter extends BaseAdapter implements OptimizeGridAdapter<GridAdapter.Item>{
    ...
    public GridAdapter(Context context) {
        for (int i = 0; i < 20; i++) {
            ...
            object.text = "Text "+i;
            object.resId = R.drawable.hotel_benn_sightseeing_berlin_brandenburger_tor;
            mItems.add(object);
        }
        mContext = context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.my_trip_grid_item, null);
        }
